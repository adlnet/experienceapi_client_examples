...
$(document).ready(function(){
	...
	TC_GetActivityProfile ("http://adlnet.gov/JsTetris_XAPI", "highscores", RenderHighScores);
	TC_GetStatements(0,"http://adlnet.gov/expapi/verbs/completed","http://adlnet.gov/JsTetris_XAPI",RenderTetrisScoreChart);
...
function RenderGolfData(xhr){
	...
	TC_GetStatements(0,'completed',"http://adlnet.gov/GolfExample_XAPI/GolfAssessment.html",RenderGolfDataScores);
...
function RequestGolfQuestions(){
	...
	TC_GetStatementsWithinContext(0, 'answered', 'http://adlnet.gov/GolfExample_XAPI', RenderGolfQuestions);
...
function RequestLocations(){
	...
	TC_GetStatementsWithinContext(0, 'experienced', 'http://adlnet.gov/Course/NashvilleMuseumsTour', RenderLocations);
